...
def dashport(stdscr):
    ...
    app.print("panel 0", x=1, y=1, panel=0, A_BOLD=True, A_ITALIC=True)
    ...
    app.print(f"Columns: {app.panel_dimensions[0][1]}", x=5, y=3,
              panel=0, A_REVERSE=True)
    app.print("panel 1", x=1, y=1, panel=1, A_BOLD=True, A_ITALIC=True)
    ...
    app.print(f"Columns: {app.panel_dimensions[1][1]}", x=5, y=3,
              panel=1, A_REVERSE=True)
    app.print("panel 2", x=1, y=1, panel=2, A_BOLD=True, A_ITALIC=True)
    ...
    app.print("panel 3", x=1, y=1, panel=3, A_BOLD=True, A_ITALIC=True)
